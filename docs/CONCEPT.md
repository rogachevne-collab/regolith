...
|------|------------|----------|
| PoC 1a–1c ✓ | подвеска / привод / руль | modular rover (`test_simulation_wheel`) |
| PoC 2 ✓ | live structural rebuild | `test_assembly.tscn`, kernel damage/split |
| PoC 3 ✓ | пассажир на moving grid | in-game / support-frame (legacy cart tests removed) |
...
4. **Industry v1.** Electric/cargo Flow, distributor, ISRU recipes, mining — см.
   [`specs/INDUSTRY-V1.md`](specs/INDUSTRY-V1.md).
...
6. **После slice.** Логистика, новые рецепты и материалы, краны и actuators,
   Thruster/Gyro (lunar hop / VTOL — `specs/POC-THRUSTERS-V0.md`),
   визуальная автоматика (`docs/specs/CONTROL-GRAPH-V0.md`), более сложные
   машины, герметичность и атмосферы.
