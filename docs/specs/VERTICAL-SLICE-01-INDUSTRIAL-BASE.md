...
- короткое действие по нажатию и продолжительное действие с прогрессом;
- подсветка цели, допустимость действия, progress и результат;
...
12. Входящие в slice действия имеют финальные animation/VFX/SFX и UI feedback,
    достаточные для чтения состояния без debug overlay.
