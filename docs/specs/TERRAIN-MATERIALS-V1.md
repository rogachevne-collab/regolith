...
3. Разложить **пятна** (spot-noise): радиус, частота, привязка к биому.
...
В радиусе ~200 м от spawn (детерминированный overlay от seed):

- гарантирован фон биома спавна;
- ≥1 линза `mat_ilmenite` (или pyroxene+ilmenite кластер, если спавн в mare);
- ≥1 линза `mat_anorthite` (если highland — на месте; если mare — ближайший
  highland-карман / принудительный overlay);
