...
| # | Работа | Размер | Зависимости |
|---|--------|--------|-------------|
| V2-1 | Честный carve-бюджет | часы | — |
| V2-2 | Grind-борозда sustained | часы | — |
| V2-3 | VFX удара | ~день | — |
| V2-4 | Лут от кинетики | ~день | V2-1 (объём уже честный) |
| V2-5 | Tier 2: давление / yield | дни | V2-1; желательно после V2-4 |
| V2-6 | Урон игроку | дни | V2-5 не нужен; после V2-3 логично |
