...
7. Wire presentation: тонкий чёрный кабель (capsule-сегменты — стыки на
   изгибах бесшовные), лёгкое провисание на span; grinder по любому
   сегменту срезает кабель.
