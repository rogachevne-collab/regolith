...
Единственная защита — **subgrid immunity**: контакты внутри **одной** assembly
(base ↔ head) не наносят damage/carve, как physical group в SE. Отвалившийся после
split фрагмент — уже независимый агент и бьёт на общих правах.
