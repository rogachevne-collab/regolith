...
#
# Regolith's own copy. The identical script also ships as a demo file with the
# Ropes! plugin, which lives in its own repository now — game scenes must not
# preload it from there, because a released plugin drops its demos.
